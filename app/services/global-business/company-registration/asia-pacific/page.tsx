...
export const metadata = {
  title: 'Company Registration - Asia-Pacific - Legal Door',
  description: 'Expert legal services for company formation across Asia-Pacific: Singapore, Hong Kong, Thailand, Malaysia, India, Sri Lanka, Philippines, Australia, and New Zealand.',
};
