...
export const metadata = {
  title: 'Company Registration - Europe - Legal Door',
  description: 'Expert legal services for company formation across Europe: UK, Germany, Switzerland, Netherlands, Estonia, Poland, Cyprus, and Georgia.',
};
