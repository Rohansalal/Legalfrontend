...
export const metadata = {
  title: 'Consumer Protection Lawyers - Legal Door',
  description: 'Expert consumer protection and rights services.',
};

const services = [
  { title: 'Consumer Rights', description: 'Protection and enforcement of consumer rights.' },
  { title: 'Defective Products', description: 'Legal action for defective products.' },
  { title: 'Service Deficiency', description: 'Complaints for deficient services.' },
];
    ...
    <main className="min-h-screen">
      ...
      <div className="container mx-auto py-24 px-4 pt-32">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6">Consumer <span className="text-primary">Protection</span></h1>
          <p className="text-lg text-slate-600 leading-relaxed font-medium">
            Expert consumer protection services for defective products and service deficiency.
          </p>
        </div>
