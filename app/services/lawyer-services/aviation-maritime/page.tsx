...
const sections = [
  ...
  },
  {
    ...
    icon: Anchor,
    description:
      'Shipping and admiralty matters — vessel licensing, arrest, finance, charter parties, cargo claims and maritime disputes.',
    services: [
  ...
  },
  {
    ...
    icon: Globe,
    description:
      'Cross-border transactions, trade, immigration, citizenship and enforcement matters for individuals and corporates across jurisdictions.',
    services: [
