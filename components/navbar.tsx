...
const lawyerCategories = [
  ...
  },
  {
    ...
    subServices: [
      { title: 'Aircraft Sale / Purchase / Leasing', href: '/services/lawyer-services/aviation-maritime/aviation/aircraft-sale-purchase-leasing' },
      { title: 'Airline Start-up & Certification', href: '/services/lawyer-services/aviation-maritime/aviation/airline-startup-certification' },
      { title: 'DGCA Compliances', href: '/services/lawyer-services/aviation-maritime/aviation/dgca' },
      { title: 'AERA / AAI / BCAS Approvals', href: '/services/lawyer-services/aviation-maritime/aviation/aera' },
      { title: 'ICAO / IATA Advisory', href: '/services/lawyer-services/aviation-maritime/aviation/icao' },
      ...
      { title: 'Ship License (Maritime)', href: '/services/lawyer-services/aviation-maritime/maritime/ship-license' },
      { title: 'Cross-Border Transactions', href: '/services/lawyer-services/aviation-maritime/international/cross-border-transactions' },
      { title: 'Money Laundering (International)', href: '/services/lawyer-services/aviation-maritime/international/money-laundering' },
    ],
  },
  {
    id: 'lawyer-family',
